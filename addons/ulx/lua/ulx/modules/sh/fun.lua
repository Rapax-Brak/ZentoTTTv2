...
function ulx.slay( calling_ply, target_plys, reason )
	...
	ulx.fancyLogAdmin( calling_ply, "#A slayed #T (#s)", affected_plys, reason )
end
local slay = ulx.command( CATEGORY_NAME, "ulx slay", ulx.slay, "!slay" )
slay:addParam{ type=ULib.cmds.PlayersArg }
slay:addParam{ type=ULib.cmds.StringArg, hint="reason", ULib.cmds.optional, ULib.cmds.takeRestOfLine }
